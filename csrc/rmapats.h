...
extern "C" {
#endif
void  hs_0_M_0_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_3_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_3_5__wrapoutputop_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_4_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_5__wrapoutputop_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_5_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_5__wrapoutputop_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_8_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_10_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_11_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_11_5__wrapoutputop_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_12_0__wrapoutputop_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_12_5__wrapoutputop_simv_daidir (UB  * pcode, UB  val);
